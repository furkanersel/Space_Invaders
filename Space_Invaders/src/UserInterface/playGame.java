...
public class playGame extends UserInterface implements ActionListener {
	
		public void actionPerformed(ActionEvent e) {
		
		
		if(!(fileuser.exists()) || fileuser == null){
			JOptionPane.showMessageDialog(null, "Please Before Register");
			System.exit(0);
		}
